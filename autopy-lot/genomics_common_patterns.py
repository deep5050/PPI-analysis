...
# + id="84C0ivcZRbBO" colab_type="code" outputId="1925138f-60fb-4fac-ed03-83be422a9590" colab={"base_uri": "https://localhost:8080/", "height": 34}
...
# + [markdown] id="OKS8ZIl3ylIO" colab_type="text"
# # NECESSARY FUNCTIONS

# + id="X37Lc_tVRlYk" colab_type="code" colab={}
...
# + id="0msQmXSsRy9K" colab_type="code" colab={}
...
# + [markdown] id="k-obFVyAyDHL" colab_type="text"
# # FINDING PATTERNS FOR DJ1

# + [markdown] id="SV4ZEU4F0AaL" colab_type="text"
# ## ATCG DISTRBUTION

# + id="c0bs_1DHR4yM" colab_type="code" outputId="1e4cce03-f226-4e27-e66b-7d12d0b216b0" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',3)

# + id="ko_yHlgLR8aw" colab_type="code" outputId="87294686-dee4-40c1-ac6d-eebbb07323b7" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',4)

# + id="tIBp3j0uSfYi" colab_type="code" outputId="0334f8c7-369f-4409-fa46-a0e35a25c3d2" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',5)

# + id="iAdvkxJ-SnQy" colab_type="code" outputId="5c578561-fe46-4b49-a604-0edf241fe623" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',6)

# + id="ZADqdOuzSrSH" colab_type="code" outputId="a7894130-c787-4aaf-c09e-4af79657c4e6" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',7)

# + id="ZUlUJoqQSw8w" colab_type="code" outputId="421402dd-0be4-4895-ba64-af26b0db9674" colab={"base_uri": "https://localhost:8080/", "height": 34}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',8)

# + id="7p3xhnmUTEBJ" colab_type="code" outputId="b9570618-835b-4ecf-d9eb-9e1c28cd22fb" colab={"base_uri": "https://localhost:8080/", "height": 34}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',9)

# + [markdown] id="Pp62ekDJ0IsI" colab_type="text"
# ## YR DISTRIBUTION

# + id="KQIf4zPm-CIl" colab_type="code" outputId="a29665c2-b764-4061-9327-006c0e96db3f" colab={"base_uri": "https://localhost:8080/", "height": 34}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',3,MODE='YR')

# + id="EcVS9VDf-HHw" colab_type="code" outputId="b847a739-f2ae-47ab-cad6-75118795e275" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',4,MODE='YR')

# + id="dEFlQCia_99F" colab_type="code" outputId="4434b87b-aa40-4c4a-9a82-90c7f15ee6d9" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',5,MODE='YR')

# + id="FI_S17H_ACMJ" colab_type="code" outputId="44386685-6af3-452d-b52f-0e00f1de2c6f" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',6,MODE='YR')

# + id="7z-EKTAeAGIP" colab_type="code" outputId="aaeaa4a9-2846-431b-8028-5f830cbaff05" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',7,MODE='YR')

# + id="iIVCp3-cAJcs" colab_type="code" outputId="eff84784-9a6f-4c83-b023-4bea8504f8cb" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',8,MODE='YR')

# + id="LLdwtzvHANKL" colab_type="code" outputId="51239bd2-3280-43c8-aa36-1226fd015750" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',9,MODE='YR')

# + id="yZhpqcX7ARgC" colab_type="code" outputId="07e02750-f18d-48ea-f9c3-519c8e6a3c15" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',10,MODE='YR')

# + id="MmW8RNzCAXFQ" colab_type="code" outputId="e4591552-6f6d-4b8c-d458-bf18f1cafc15" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',11,MODE='YR')

# + id="IbQno-E7AbNE" colab_type="code" outputId="c105e43e-ae52-4859-dc38-80a9ede522a6" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',12,MODE='YR')

# + id="a4ss47uuAlvH" colab_type="code" outputId="88410c07-a0c8-4b3f-f683-c3de5dd82588" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',13,MODE='YR')

# + id="OT5S8HS8AqDE" colab_type="code" outputId="1b345675-69bc-447d-8b6e-fcb634e7b84e" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',14,MODE='YR')

# + id="UiBEQJipAuuX" colab_type="code" outputId="fa87bb42-c2df-4c2b-dce8-c99514606f81" colab={"base_uri": "https://localhost:8080/", "height": 34}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',15,MODE='YR')

# + id="azKFYmOXAyya" colab_type="code" outputId="ac0a314b-27b4-4c3a-d617-cc54c87eb005" colab={"base_uri": "https://localhost:8080/", "height": 34}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/DJ1',16,MODE='YR')

# + [markdown] id="p4kAiQ8fy455" colab_type="text"
# ## RESULT
#

# + id="qZZM_e6_BS1X" colab_type="code" outputId="2882d600-901c-4150-c2e8-7fcf3a2bf978" colab={"base_uri": "https://localhost:8080/", "height": 441}
...
# + [markdown] id="YZlwlY2xsYSd" colab_type="text"
# # FINDING PATTERNS FOR PARKIN

# + [markdown] id="ClEfnYsrzt-N" colab_type="text"
# ## ATCG DISTRIBUTION

# + id="bCstkikCrFPJ" colab_type="code" outputId="f483f254-3196-4abe-fef3-731b7a7bd197" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',3)

# + id="qGdn5rCqrRQn" colab_type="code" outputId="c6d3b4ab-e29e-44d7-b575-45d92f2a5a3a" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',4)

# + id="3qJvjtv1rfS1" colab_type="code" outputId="e9f697ce-d788-40fa-a495-3802d6d3eef7" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',5)

# + id="bVwalpSirn6q" colab_type="code" outputId="578dfc2a-7326-4edb-c36c-94565511081c" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',6)

# + id="hXu3u7Wjrwuw" colab_type="code" outputId="d7612f2d-68d3-45cc-fa33-438d0ca49dfc" colab={"base_uri": "https://localhost:8080/", "height": 34}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',7)

# + id="iEk24t9Tr69Z" colab_type="code" outputId="f49ec862-37f2-4423-e1ac-5e03a7a6c7e1" colab={"base_uri": "https://localhost:8080/", "height": 34}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',8)

# + [markdown] id="3hfgUu4nzmbz" colab_type="text"
# ## YR DISTRIBUTION

# + id="3K3EJTtHsxlp" colab_type="code" outputId="447871f6-0f7c-4b60-ddcd-c8d0ba903301" colab={"base_uri": "https://localhost:8080/", "height": 34}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',3,MODE='YR')

# + id="QP8o6CcLs4GF" colab_type="code" outputId="51946cb6-36d0-4e71-b90f-20ac2a3ace3c" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',4,MODE='YR')

# + id="7Aawv-zOtCHN" colab_type="code" outputId="03540d65-062d-40c5-cf04-81bee03a42a6" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',5,MODE='YR')

# + id="kfZ0Yd0itE29" colab_type="code" outputId="2b8b4198-b701-4dd3-e5e8-76f38762d53c" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',6,MODE='YR')

# + id="LVBWsA-Hthz_" colab_type="code" outputId="f6a93385-4907-4527-834c-3ebe284b20c7" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',7,MODE='YR')

# + id="HiaXwilLt2um" colab_type="code" outputId="c69ca1bd-41df-45e8-c382-1578d325afd2" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',8,MODE='YR')

# + id="gFe9HcnduBvu" colab_type="code" outputId="971f68d8-5aab-4452-98c1-56579abc0bda" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',9,MODE='YR')

# + id="IgBowm2BuMSA" colab_type="code" outputId="e7e80a3e-a358-4a3a-edc5-2b84f3f2db1c" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',10,MODE='YR')

# + id="4-tjLO7MuWL6" colab_type="code" outputId="21e888b0-44f4-48e6-9c3d-c68fd3c8bd54" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',11,MODE='YR')

# + id="ckbOOrFluf0k" colab_type="code" outputId="3703325f-a237-43a9-832f-6aa189827395" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',12,MODE='YR')

# + id="jBWmW0GIuqAf" colab_type="code" outputId="15065f45-3ad8-412c-8e8c-26e3809d8da5" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',13,MODE='YR')

# + id="OZx_CPpWu1Hk" colab_type="code" outputId="7537a8c5-7404-4f2d-8bf7-991801da6c53" colab={"base_uri": "https://localhost:8080/", "height": 34}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',14,MODE='YR')

# + id="uwxm6O8KvAy-" colab_type="code" outputId="c5ffea26-928e-4196-99ca-ddbed427ee12" colab={"base_uri": "https://localhost:8080/", "height": 34}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PARKIN',15,MODE='YR')

# + [markdown] id="dSmYyT7CzFJS" colab_type="text"
# ## RESULT

# + id="X2oPTN6TvPtr" colab_type="code" outputId="a7db9db5-ed0e-4716-aaa0-51d0647be0fd" colab={"base_uri": "https://localhost:8080/", "height": 441}
# YR distribution plot
...
# + id="eg01hBnZwf6x" colab_type="code" colab={}


# + [markdown] id="-CSamhJg0aAN" colab_type="text"
# # FINDING PATTERNS FOR PINK1

# + [markdown] id="8j3SXeZI0jhJ" colab_type="text"
# ## ATCG DISTRIBUTION

# + id="f5opG6ge0mDO" colab_type="code" outputId="3487f72c-48f0-4288-dbe3-dd2ee5542169" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',3)

# + id="ixTfDgeS0oN1" colab_type="code" outputId="aa280aa5-7204-4757-bddd-77958aee47d2" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',4)

# + id="zUn4jw8_0tl4" colab_type="code" outputId="3fe57174-2658-4eb7-daf7-da52561d78ae" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',5)

# + id="aC79-3ma0wxn" colab_type="code" outputId="8605c52d-7d6a-4fe5-ecd9-164d8293daae" colab={"base_uri": "https://localhost:8080/", "height": 54}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',6)

# + id="5vqW3ST20zvd" colab_type="code" outputId="48810d31-7d4b-4e00-edf4-047794956d2b" colab={"base_uri": "https://localhost:8080/", "height": 34}
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',7)

# + id="6vpQhBsN027c" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 34} outputId="0d7120f4-f84d-4271-cc45-596f4fe1ef0a"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',8)

# + [markdown] id="xp_iZmrJ0-zw" colab_type="text"
# ## YR DISTRIBUTION

# + id="iYj6kmEE1BKH" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 34} outputId="618919bd-762c-4f53-b6a9-0d1b8502bf77"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',3,MODE='YR')

# + id="LqIr94NS1GLc" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 54} outputId="231723b2-f6f2-4c45-b8c0-8d4d7f81c38e"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',4,MODE='YR')

# + id="B-4TYKun1JoT" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 54} outputId="e2f6b080-7173-4ff5-8f8d-ab9fcfe1d614"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',5,MODE='YR')

# + id="vMIxurAJ1RU-" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 54} outputId="57a87d87-9c39-4347-c303-b0d8810050bf"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',6,MODE='YR')

# + id="HC57-ZQZ1Ujt" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 54} outputId="3c7ef0d9-0126-4570-b206-c6727c485496"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',7,MODE='YR')

# + id="Crdo2uE_1YAS" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 54} outputId="a052f927-66bd-475f-e000-7787ac47dad4"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',8,MODE='YR')

# + id="11YzeT8M1bSp" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 54} outputId="d98a6766-8d9d-48e4-de35-57b8628af55c"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',9,MODE='YR')

# + id="nIZM-7gU1fYV" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 54} outputId="d1d6f5ec-3d7c-4dc5-8630-19cf3b931ed6"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',10,MODE='YR')

# + id="6GXID3nB1jNz" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 54} outputId="21af93a5-86c2-46f8-bb0d-e8d9d8a38f3b"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',11,MODE='YR')

# + id="-AR1pXej1m9r" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 54} outputId="f49496d9-34f7-4096-8ddf-275313c1cc6e"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',12,MODE='YR')

# + id="M3n7whIK10yZ" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 34} outputId="dd220164-6a83-4f89-e8a8-4f671e2a2d47"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',13,MODE='YR')

# + id="10YMTTVb14sW" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 34} outputId="8557050b-d1e4-4d09-9040-6e99f8d6d30f"
common_patterns_diff_lengths_among_all('/gdrive/My Drive/Genomics/job/data/PINK1',14,MODE='YR')

# + [markdown] id="LN_Gy80LDMfL" colab_type="text"
# ## RESULT

# + id="riICtxVa18g8" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 441} outputId="0e05fcf0-9849-4a99-b1cd-13e663d8f385"
# YR distribution plot
...
# + [markdown] id="3CghU054Bmlj" colab_type="text"
# # FINAL GRAPH

# + id="MBJZDGp-Bp1u" colab_type="code" colab={"base_uri": "https://localhost:8080/", "height": 295} outputId="41a3e01a-6c0b-4460-8be9-94ad82261e0a"
