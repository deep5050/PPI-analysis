...
# + id="vYscPs087lAj" colab_type="code" colab={}
...
# + id="Y69jrA6OBrEJ" colab_type="code" colab={}
...
# + id="p7o_DyWoI61O" colab_type="code" colab={}


# + id="kFtMhggf7k_b" colab_type="code" outputId="14497e3e-44f6-4823-f2d2-0747be4898df" colab={"base_uri": "https://localhost:8080/", "height": 405}
import numpy as np
import pandas as pd
...
# + id="WXBt-4WLsoGr" colab_type="code" colab={}


# + id="ybogyvtNu0Nf" colab_type="code" colab={}

from os import listdir
from os.path import isfile, join


# + id="DELGd76qu3ES" colab_type="code" colab={}
import json


# + id="ZyvMeOkEvER5" colab_type="code" colab={}
...
# + id="OQlmhLqWzHMZ" colab_type="code" outputId="5ef0ccfb-ded2-4fb6-f5ef-39d40a24eb82" colab={"base_uri": "https://localhost:8080/", "height": 1000}
...
# + id="fRWNWHY2JffX" colab_type="code" colab={}
...
# + id="-Wh0zAnx2d-8" colab_type="code" colab={}
print("ok")
